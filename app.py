...
st.markdown("""
    <style>
        ...
        * { font-family: 'Pretendard', sans-serif; }
        ...
        .stat-left b { font-size: 1.1em; color: #d1d1d6; }
        .stat-left .hl-gold { font-size: 1.4em; font-weight: 900; color: #D4AF37; margin-top: 2px; }
...
with stats_container:
    ...
    <div class='stat-container'>
        <div class='stat-box-new'>
            <div class='stat-left'><b>전체 단지</b><div class='hl-gold'>{total_units}</div>세대</div>
        ...
        <div class='stat-box-new dong-box'>
            <div class='stat-left'><b>{selected_dong}</b><div class='hl-gold'>{dong_units}</div>세대</div>
            <div class='stat-right'>
