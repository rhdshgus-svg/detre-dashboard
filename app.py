...
with tab2:
    ...
    fortunes = [
        ...
        "**[건강운]** 스트레스가 머리로 몰려 짜증이 치솟는 날입니다. 괜히 가까운 사람에게 화풀이했다가 큰 코 다칩니다. 오늘 저녁엔 무조건 만사 제쳐두고 맛있는 거 드세요! 든든하게 배를 채워야 큰 돈을 만질 기운이 솟아납니다.",
        "**[직장/사업운]** 오지랖 부리다가 남의 일까지 독박 쓰기 딱 좋은 사주입니다. 오늘은 무조건 '내 코가 석 자' 마인드로 눈치껏 빠지세요! 얄밉게 처신하는 게 오히려 유능함으로 포장되어 돌아오는 기가 막힌 날입니다."
    ]
